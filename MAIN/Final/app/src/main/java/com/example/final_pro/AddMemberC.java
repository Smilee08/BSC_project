...
public class AddMemberC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_member_c);
        ...
        add.setOnClickListener(view -> {
            ...
            database.child(name).setValue(new_member1).addOnSuccessListener(unused -> {
                Toast.makeText(AddMemberC.this, "Details added Successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), WingC.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddMemberC.this, "Error!!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    ...
    public void onBackPressed () {
        Intent intent = new Intent(this, WingC.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        //super.onBackPressed();
