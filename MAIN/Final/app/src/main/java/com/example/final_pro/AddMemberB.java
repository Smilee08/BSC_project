...
public class AddMemberB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(view -> {
            ...
            database.child(name).setValue(new_member1).addOnSuccessListener(unused -> {
                Toast.makeText(AddMemberB.this, "Details added Successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), WingB.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddMemberB.this, "Error!!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    ...
    public void onBackPressed () {
        Intent intent = new Intent(this, WingB.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        //super.onBackPressed();
