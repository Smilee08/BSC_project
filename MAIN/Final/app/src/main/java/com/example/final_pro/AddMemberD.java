...
public class AddMemberD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_member_d);
        ...
        add.setOnClickListener(view -> {
            ...
            database.child(name).setValue(new_member1).addOnSuccessListener(unused -> {
                Toast.makeText(AddMemberD.this, "Details added Successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), WingD.class);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddMemberD.this, "Error!!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, WingD.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        //super.onBackPressed();
